package com.shellcore.android.moviemanager.fragments;
...
import com.shellcore.android.moviemanager.adapters.MovieRecyclerViewAdapter;
...
public class UpcomingFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        recMovies.setLayoutManager(new LinearLayoutManager(getContext()));
